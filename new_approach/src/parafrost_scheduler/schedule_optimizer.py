"""Optimization loops for the full joint schedule solver.

Extracted from schedule_solver.py — provides the streaming native
optimizer, the legacy linear-scan solver, a JSON serializer, and
the progressive-solve wrapper.
"""
